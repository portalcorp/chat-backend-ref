...
import { MessageUpdateType, type MessageUpdate } from "@/lib/types/message-update";
import type { Conversation } from "@/lib/types/conversation";
import type { EndpointMessage } from "../endpoints";
import { generateFromDefaultEndpoint } from "../generate-from-default-endpoint";
...
export async function generateTitle(prompt: string) {
	if (!process.env.LLM_SUMMERIZATION) {
