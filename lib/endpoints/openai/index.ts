...
import { z } from "zod";
import { openAIChatToTextGenerationStream } from "./chat-to-text-generation-stream";
import { openAICompletionToTextGenerationStream } from "./completion-to-text-generation-stream";

import { buildPrompt } from "@/lib/build-prompt";
import type { Endpoint, EndpointMessage } from "@/lib/endpoints";
...
export const endpointOAIParametersSchema = z.object({
	...
	apiKey: z.string().default(process.env.OPENAI_API_KEY ?? "sk-"),
	completion: z
